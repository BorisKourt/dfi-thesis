...
\newthought{Each subsection} breaks down into an answer and question paring, with the questions appearing in the margin and the answers appearing to the left. This is a reverse format for what has been done in books like The Little Schemer \citep{littleSchemer} and The Reasoned Schemer \citep{reasonedSchemer}, both books are for learning the fundamentals of functional and logic programming.
